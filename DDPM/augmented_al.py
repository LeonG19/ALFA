...
def main():
    ...
    ddpm = GaussianMultinomialDiffusion.from_scaled_df(
        df               = df_tvae,
        categorical_cols = discrete,
        hidden_dims      = [100, 100],
        num_timesteps    = 1000,
    ...
    n_samples = X_under.shape[0] * args.num_synthetic

    # 6) Generate synthetic
    df_syn = ddpm.sample_df(samples=n_samples)
